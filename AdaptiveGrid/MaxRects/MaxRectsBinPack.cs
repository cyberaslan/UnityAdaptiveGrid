...
namespace msmshazan.TexturePacker
{
    public class MaxRectsBinPack
    {
        ...
        /// @param rects The list of rectangles to insert. This RectSize will be destroyed in the process.
        /// @param dst [out] This list will contain the packed rectangles. The indices will not correspond to that of rects.
        /// @param method The rectangle placement rule to use when packing.
        public void Insert(List<RectSize> rects, List<BinRect> dst, FreeRectChoiceHeuristic method)
        {
            dst.Clear();
            ...
            while (rects.Count > 0)
            {
                ...
                for (int i = 0; i < rects.Count; ++i)
                {
                    int score1 = 0;
                    int score2 = 0;
                    BinRect newNode = ScoreRect(rects[i].width, rects[i].height, false, method, ref score1, ref score2);
